...
setwd(here::here('prep/CS_CP_HAB/Mangrove/Extracted_regional_value _csv'))


# calculate 5 year trend ---------------------------------------------------------

mang<-read.csv("hab_mangrove_extent_ken2018.csv",header = T,stringsAsFactors = F)
...
write.csv(r.trend2,"hab_mangrove_trend_ken2018.csv",row.names = F)
