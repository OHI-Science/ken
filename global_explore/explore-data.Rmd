...
**NOTE!!!!! This is in progress, in development from a workshop in Samoa. The data displayed is from Kenya but the text is still Samoa.**
...
rgn_spp_gl <- rgn_spp_gl_csv %>%
  ...
  left_join(ico_global_list %>%
            ...
            by = "sciname") %>%
  select(sciname, comname, iucn_sid, cat_code) # n_spp_rgn; this = n_rows: 1467 for samoa
